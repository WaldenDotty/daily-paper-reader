...
tldr: 针对非线性自主系统在模型预测路径积分（MPPI）控制中受限于动力学模型精度的问题，本文提出ICODE-MPPI框架。该方法利用输入伴随神经常微分方程（ICODEs）学习并补偿未建模的残差动力学，确保了预测过程中的物理一致性和时间连续性。实验表明，该方法在复杂轨迹下显著降低了跟踪误差并减少了控制抖动，提升了系统的鲁棒性。
selection_source: fresh_fetch
motivation: 传统的MPPI控制性能受限于名义动力学模型的精度，难以应对复杂的未建模扰动。
method: 提出ICODE-MPPI框架，通过神经常微分方程（ICODEs）在连续时间域内学习残差动力学并与MPPI结合。
result: "在高保真仿真中，ICODE-MPPI相比标准MPPI将横向跟踪误差降低了高达69%，并显著抑制了控制抖动。"
conclusion: ICODE-MPPI通过连续时间残差学习有效提升了车辆路径跟踪的鲁棒性和控制平滑度。
---

## 摘要
模型预测路径积分 (MPPI) 控制是一种针对非线性自主系统的强大采样策略。然而，其性能往往受限于标称动力学的保真度。我们提出了 ICODE-MPPI，这是一个利用输入伴随神经常微分方程 (ICODEs) 来学习并补偿未建模残差动力学的鲁棒框架。与离散时间学习器不同，ICODEs 在 MPPI 预测时域内保持了物理一致性和时间连续性。在复杂轨迹上的高保真仿真表明，与标准 MPPI 控制相比，ICODE-MPPI 在持续扰动下可将横向跟踪误差降低高达 69%。此外，我们的分析证实，ICODE-MPPI 显著抑制了控制抖振，从而产生了更平滑的转向指令和更优越的鲁棒性能。
